...
class GotapController extends PublicController
{
    ...
    public function getIndex()
    {
        ...
        return $theme->scope('index', compact('products', 'portfolios', 'introductions', 'sections', 'productCards', 'questions'))->render();
    }
    ...
    public function getDetails($id)
    {
        ...
        return $theme->scope('product-details', compact('product', 'productCards'))->render();
    }
