        ...
        <div class="profile-type-1 max-w-3xl m-auto">
            <div class="profile-detail">
                <div class="profile-box">
                    <div class="user-profile-info items-center -mb-8">
                        <div class="profile-cover h-44 bg-cover"
                             style="background-image: url('{{ $account->cover ? RvMedia::getImageUrl($account->cover) : RvMedia::getImageUrl(theme_option('default-cover'))}}');"></div>
                        <div class="profile-avatar h-32 w-32 m-auto relative -top-14 rounded-full border-2">
                            <img width="200"
                            ...
                            <div class="text-2xl flex justify-center items-center">
                                @if($account->fullname)
                                    <div class="verified-account">
                                        <img src="{{ Theme::asset()->url('layoutone/assets/images/icons/verified-1.png') }}"
                                             alt="verified">
                                    </div>
            ...
            <div class="profile-app-link grid grid-cols-3 gap-4 justify-items-center mt-5 mx-2 mb-6 min-35-vh">
                @foreach($account->items as $item)
                    <div @if($item->social->is_bank) class="link-item is_bank" @else class="link-item is_social" @endif data-social='{{ $item }}' >
                        <div class="flex flex-col">
                            <a class="w-28 m-auto">
                                <img src="{{ RvMedia::getImageUrl($item->social->icons->first()->image) }}" alt="img"
                                     class="image img-fluid">
                            </a>
                            <span class="text-center font-medium text-gray-800 mt-1">{{ $item->social->name }}</span>
                        </div>
                    </div>
                @endforeach
            </div>
