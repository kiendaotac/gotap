<div class="pd-wrap">
    <div class="container">
        <div class="heading-section">
            <h2 class="text-capitalize">Thông tin chi tiết sản phẩm</h2>
        </div>
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="product-dtl">
                    <div class="product-info">
                        ...
                        <div class="reviews-counter">
                            ...
                            <span>{{ $product->star }} Đánh giá</span>
                        </div>
                        <div class="product-price-discount"><span>{{ number_format($product->price , 0, ',','.') }} ₫</span><span class="line-through">{{ number_format($product->old_price , 0, ',','.') }} ₫</span></div>
                    </div>
                    <p>{{ $product->bio }}</p>
                    <div class="product-count">
                        ...
                        <form action="{{ route('public.member.add-to-cart') }}" method="POST">
                            ...
                            <div class="inline-block w-100 pt-2">
                                <button type="submit" class="btn btn-muangay btn-primary" style="width: 49% !important;">Thêm vào giỏ hàng</button>
                                <a href="{{ $product->link }}" class="btn btn-shopee" style="width: 49% !important;">Mua trên Shopee</a>
                            </div>
                        </form>
                    </div>
                </div>
