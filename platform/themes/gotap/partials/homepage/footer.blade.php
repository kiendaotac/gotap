                ...
                <div class="col-lg-4">
                    <div class="widget clearfix">
                        ...
                        <div class="center topmargin-sm">
                            ...
                            <a href="{{ theme_option('instagram') }}" class="social-icon inline-block border-0 si-small si-instagram"
                               title="Instagram">
                                <i class="icon-instagram"></i>
                                <i class="icon-instagram"></i>
                            </a>
                            <a href="{{ theme_option('youtube') }}" class="social-icon inline-block border-0 si-small si-youtube"
                               title="youtube">
                            ...
                            <a href="{{ theme_option('shopee') }}" class="social-icon inline-block border-0 si-small si-youtube"
                               title="shopee">
                                <i><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                        viewBox="0 0 362 535.3" style="width: 32px; height: 32px" xml:space="preserve">
<style type="text/css">
    .st0{fill:#EA501F;}
    .st1{fill:#FFFFFF;}
</style>
